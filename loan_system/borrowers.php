			...
			<div class="card-body">
				<table class="table table-bordered" id="borrower-list">
					...
					<tbody>
						<?php
						$i = 1;
							$qry = $conn->query("SELECT * FROM loans order by id desc");
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>National ID :<b><?php echo $row['national_id'] ?></small></b></p>
								 <p><small>Date_of_Borrrowing :<b><?php echo $row['date'] ?></small></b></p>
						 		
						 	</td>
						 	<td class="">
							 <p><small>Loan Type :<b><?php echo $row['loan_type'] ?></small></b></p>
							 <p><small>Loan Plan :<b><?php echo $row['loan_plan'] ?></small></b></p>
							 <p><small>Loan Amount :<b><?php echo $row['loan_amount'] ?></small></b></p>
							</td>
						 	<td class="">N/A</td>
